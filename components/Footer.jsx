...
const Footer = () => {
  return (
    <footer>
      <div className="bg-gray-800 text-muted-foreground py-8">
        <div className="container mx-auto px-4 md:px-8">
          <div className="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="socials flex flex-col gap-2 ">
              <h3 className="text-xl text-neutral-brown font-bold">
      ...
      <div className="border-t bg-gray-800 text-muted-foreground">
        <div className="container mx-auto flex justify-between px-4 md:px-8 py-3">
          <p>&copy; {new Date().getFullYear()} Ghana Xpert Travel and Tour</p>
